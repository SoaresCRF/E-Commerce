...
<div class="container-fluid pt-5">
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">Todos Produtos</span></h2>
        ...
        <?php
        if (isset($_SESSION['ultrapassou_estoque_disponivel'])) :
        ?>
            <p style="color: red; font-size: 22px;">Ultrapassou o estoque disponível. Item não adicionado!</p>
        <?php
        endif;
        unset($_SESSION['ultrapassou_estoque_disponivel']);
        ?>

        <?php
        if (isset($_SESSION['estoque_esgotado'])) :
        ?>
            <p style="color: red; font-size: 22px;">Estoque esgotado!</p>
        <?php
        endif;
        unset($_SESSION['estoque_esgotado']);
        ?>
