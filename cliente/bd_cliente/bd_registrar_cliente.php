...
$sql = "SELECT count(*) as total from clientes_cadastrados where cpf = '$cpf'";
$query_clientes_cadastrados = mysqli_query($conexao, $sql);
$row_clientes_cadastrados = mysqli_fetch_assoc($query_clientes_cadastrados);
if ($row_clientes_cadastrados['total'] == 1) {
...
$sql = "SELECT count(*) as total from clientes_cadastrados where username = '$username'";
$query_clientes_cadastrados = mysqli_query($conexao, $sql);
$row_clientes_cadastrados = mysqli_fetch_assoc($query_clientes_cadastrados);
if ($row_clientes_cadastrados['total'] == 1) {
...
$sql = "INSERT INTO clientes_cadastrados (nome_cliente, cpf, email, celular, data_nasc, sexo, cep, estado, cidade, bairro, rua, numero_casa, username, senha, data_cadastro) VALUES ('$nome_cliente', '$cpf', '$email', '$celular', '$data_nasc', '$sexo', '$cep', '$estado', '$cidade', '$bairro', '$rua', '$numero_casa', '$username', '$senha', NOW())";
