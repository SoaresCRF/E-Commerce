...
<div class="container-fluid pt-5">
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">Bebidas</span></h2>
        <?php
    ...
    <div class="row px-xl-5 pb-3">
        <?php
        $query_produtos = mysqli_query($conexao, "SELECT * FROM produtos where categoria = 'Bebida' order by nome_produto, fornecedor");
