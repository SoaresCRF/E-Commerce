    ...
    <div class="container-fluid" style="width: inherit;">
        ...
        <div class="row">
            <div class="col-sm">
                <!-- Conteúdo -->
                <?php
                $query_controle_venda = mysqli_query($conexao, "SELECT nome_produto, fornecedor, sum(qtd_comprada), sum(total_venda) from controle_venda group by nome_produto, fornecedor order by qtd_comprada desc");

                if (mysqli_num_rows($query_controle_venda) > 0) { ?>
                    <div class="table-responsive">
                        <table id="top-geral" class="display table" style="width:100%">
