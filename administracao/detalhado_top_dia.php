    ...
    <div class="container-fluid" style="width: inherit;">
        ...
        <div class="container has-text-centered">
            <div class="column is-4 is-offset-4">
                <h3 class="title has-text-grey">Top diário</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm">
                <!-- Conteúdo -->
                <?php
                $query_controle_venda = mysqli_query($conexao, "SELECT nome_produto, fornecedor, sum(qtd_comprada), sum(total_venda) from controle_venda where data_venda = CURDATE() group by nome_produto, fornecedor order by qtd_comprada desc");
